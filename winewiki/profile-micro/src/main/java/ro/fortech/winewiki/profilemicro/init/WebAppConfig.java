package ro.fortech.winewiki.profilemicro.init;
...
@ComponentScan("ro.fortech.winewiki.profilemicro")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("ro.fortech.winewiki.profilemicro.repository")
